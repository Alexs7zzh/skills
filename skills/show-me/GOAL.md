...
Some relationships are easier to understand through a diagram or code-shape sketch than through paragraphs or a full code reading. This skill chooses a compact visual form for the user's current question and keeps supporting explanation close to it.
...
Explain the current topic visually. Technical correctness, validation, and implementation remain the responsibility of the work being explained. This skill does not claim that a clear picture proves the code works.
