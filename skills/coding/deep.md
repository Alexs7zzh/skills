...
6. Pull eligible action or peer-agreement work at boundaries. Save context before going idle; release finished checkout batches. The master reads and summarizes meaningful outcomes and blockers as they arise, even while other work continues. Report stopped, impossible and user-blocked outcomes honestly rather than waiting for everything to be green.
